...
require (
	...
	github.com/edgexfoundry/go-mod-bootstrap/v4 v4.1.0-dev.9
...
require (
	...
	github.com/edgexfoundry/go-mod-configuration/v4 v4.1.0-dev.4 // indirect
	...
	github.com/openziti/sdk-golang v1.1.1 // indirect
