...
require (
	...
	github.com/edgexfoundry/go-mod-bootstrap/v3 v3.2.0-dev.30
...
require (
	...
	github.com/edgexfoundry/go-mod-registry/v3 v3.2.0-dev.4 // indirect
	...
	github.com/openziti/sdk-golang v0.23.14 // indirect
