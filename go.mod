...
require (
	...
	github.com/edgexfoundry/go-mod-bootstrap/v4 v4.0.0-dev.23
...
require (
	...
	github.com/edgexfoundry/go-mod-configuration/v4 v4.0.0-dev.11 // indirect
	...
	github.com/openziti/sdk-golang v0.24.0 // indirect
