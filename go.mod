...
require (
	...
	github.com/edgexfoundry/go-mod-bootstrap/v3 v3.2.0-dev.26
...
require (
	...
	github.com/openziti/edge-api v0.26.12 // indirect
	...
	github.com/openziti/sdk-golang v0.23.11 // indirect
