...
func CommandHandler(vars map[string]string, body string, method string, queryParams string, dic *di.Container) (*dsModels.Event, common.AppError) {
	...
	go common.UpdateLastConnected(d.Name, lc, configuration, dc)
	return evt, appErr
}

func execReadDeviceResource(device *contract.Device, dr *contract.DeviceResource, queryParams string, driver dsModels.ProtocolDriver, lc logger.LoggingClient, dc metadata.DeviceClient, configuration *common.ConfigurationStruct) (*dsModels.Event, common.AppError) {
...
func cvsToEvent(device *contract.Device, cvs []*dsModels.CommandValue, cmd string, lc logger.LoggingClient, dc metadata.DeviceClient, configuration *common.ConfigurationStruct) (*dsModels.Event, common.AppError) {
...
func execReadCmd(device *contract.Device, cmd string, queryParams string, driver dsModels.ProtocolDriver, lc logger.LoggingClient, dc metadata.DeviceClient, configuration *common.ConfigurationStruct) (*dsModels.Event, common.AppError) {
...
func execWriteDeviceResource(device *contract.Device, dr *contract.DeviceResource, params string, driver dsModels.ProtocolDriver, lc logger.LoggingClient, configuration *common.ConfigurationStruct) common.AppError {
...
func execWriteCmd(device *contract.Device, cmd string, params string, driver dsModels.ProtocolDriver, lc logger.LoggingClient, configuration *common.ConfigurationStruct) common.AppError {
