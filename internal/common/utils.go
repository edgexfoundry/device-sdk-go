...
func SendEvent(event *dsModels.Event, lc logger.LoggingClient, eventClient coredata.EventClient) {
...
func VerifyIdFormat(id string, drName string, lc logger.LoggingClient) error {
	if len(id) == 0 {
...
func UpdateLastConnected(name string, lc logger.LoggingClient, configuration *ConfigurationStruct, dc metadata.DeviceClient) {
